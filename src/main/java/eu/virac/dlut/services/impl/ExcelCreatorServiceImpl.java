...
public class ExcelCreatorServiceImpl implements IExcelCreatorService {
    ...
    @Override
    public Workbook createFinSourceTableExcel(int finSourceId, int year, int month) throws Exception {
        ...
        try (InputStream fis = getClass().getResourceAsStream("/templates/excel-template-finance-source.xlsx")) {
